...
# In the 20 x 20 grid below, four numbers have been marked in red.
...
# generate all sets of 4 and compute product
# vertically, horizontally, diagonally right, diagonally left
...
chunk = 4 #no. adjacent numbers
max_product = 0

# horizontal row-by-row
for row in grid:
    for i in range(n-chunk+1):
        subset = row[i:i+chunk]
...
print(f"Max product is: {max_product}")
